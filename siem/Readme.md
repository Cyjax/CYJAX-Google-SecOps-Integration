# CYJAX Threat Intelligence Dashboards for Google SecOps SIEM Integration
...
1. Download the dashboard `.json` files for CYJAX Threat Intelligence from the following [GitHub](./Dashboards) repository.
